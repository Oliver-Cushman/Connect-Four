...
public class Constants
{
    ...
    public static final String GET_MOVE_ROW = "Player %s (%s): Enter the row for your next move";
    public static final String GET_MOVE_COL = "Player %s (%s): Enter the column for your next move";
